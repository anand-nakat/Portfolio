        ...
        <div className="lg:space-y-14 page-container space-y-8">
          ...
          <section className="grid gap-6 lg:grid-cols-2 items-start ">
            ...
            <div className="max-w-2xl text-lg xl:text-xl text-gray-600 dark:text-gray-300">
              ...
              under Prof. Yadati Narahari on the "Crop Price Prediction" project. <br />
              ...
              <span className="pl-14"></span>Having gone through courses from all subject pools at IISc, I have developed a keen interset in the field
